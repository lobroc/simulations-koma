...
SPATIAL_DIMS_PX = args.spatial_dims
...
output_path = args.output_dir / f'aztek_radial_v4_{"_".join(map(str, SPATIAL_DIMS_PX))}_px_{int(args.runtime)}s_runtime_{int(args.dummy_time)}s_dummy_{"whole" if args.whole_spoke else "part"}_spoke.seq'
